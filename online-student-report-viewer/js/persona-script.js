...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderLearningProfile(profile) {
    ...
    const metricInfo = {
      ...
      behavior: { icon: '🤝', label: 'Cooperation', desc: 'Online teamwork and cooperation with teachers and peers' },
      handwriting: { icon: '💻', label: 'Engagement', desc: 'Screen engagement and active digital participation' },
          ...
          <div class="snapshot-metrics-row">
            ${Object.entries(s.metrics).map(([k, v]) => `
              <div class="snapshot-metric">
                <span class="metric-name">${{behavior:'cooperation',handwriting:'engagement'}[k]||k}</span>
