document.addEventListener('DOMContentLoaded', function () {
                        ...
                        <div class="report-info-section">
                            ...
                            <div class="info-grid">
                                <div class="info-item">
                                    ...
                                    <span class="info-value">${extractFirstName(data.teacherName || '')}</span>
                                </div>
                                <div class="info-item">
                        ...
                        <div class="report-ratings-skills-row">
                            <div class="report-ratings-section">
                                ...
                                <div class="ratings-grid">
                                    ...
                                    <div class="rating-item"><span class="rating-label">Cooperation</span><span class="rating-stars">${getStars(data.cooperation)}</span></div>
                                    <div class="rating-item"><span class="rating-label">Engagement</span><span class="rating-stars">${getStars(data.engagement)}</span></div>
                            ...
                            ${(() => {
                                ...
                                try {
                                    const skillsObj = typeof data.skills === 'string' ? JSON.parse(data.skills) : data.skills;
                                    ...
                                    <div class="report-skills-section">
                                        ...
                                        <div class="skills-grid">
                                            ${Object.entries(skillsObj).map(([name, score]) => `
                                            <div class="skill-row">
    ...
    function doSearch() {
        ...
        resultsBody.innerHTML = '<tr><td colspan="5"><div class="loading-msg"><div class="spinner"></div>Searching...</div></td></tr>';
        ...
        fetch('/api/reports/search?' + params.toString())
            ...
            .catch(err => {
                console.error(err);
                resultsBody.innerHTML = '<tr><td colspan="5" class="no-results-msg">Error loading results.</td></tr>';
            });
    }
    ...
    function renderResults(data) {
        ...
        if (data.results.length === 0) {
            resultsBody.innerHTML = '<tr><td colspan="5" class="no-results-msg">No reports found matching your search.</td></tr>';
            paginationDiv.innerHTML = '';
            return;
        }
